...
async function getWeather(location) {
  const res = await axios.get(`https://api.open-meteo.com/v1/forecast?latitude=27.55&longitude=83.05&current_weather=true`);
...
async function askAI(msg) {
  ...
  return res.data[0]?.generated_text || "माफ गर्नुहोस्, म बुझिनँ। कृपया फेरि सोध्नुहोस्।";
}
